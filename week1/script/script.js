...
function normalizeCountry(myCountry) {
    // here your code
    return myCountry.map(country => {
        return {
        name: country.name,
        region: country.region,
        avgIncome: parseFloat(country.income.toFixed(2)),
        population: Math.round(country.population),
        lifeExpectancy: parseFloat(country.lifeExpectancy.toFixed(2)) 
}});
}
...
// 
function southAsianCountries(countries) {
    return countries.filter(country => country.region == "South Asia");
}

// calculate the total population of South Asia
// southAsianPopulation =
function southAsianPopulation(countries) {
...
function southAsianMaxLifeExpectancy(countries) {
    return Math.max(...countries.map(country => country.lifeExpectancy));
}

console.log(normalizeCountry(countries))
console.log(southAsianCountries(countries))
console.log(southAsianCountries(countries))
console.log(southAsianPopulation(countries))
console.log(southAsianMaxLifeExpectancy(countries))